				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="text" id="name" name='name' placeholder="Họ tên" required autofocus="">
						</div>
						<div class="form-block">
						...
						<div class="form-block">
							...
							<input type="email" id="email" name='email' required autosave="" autocomplete="" placeholder="expample@gmail.com">
						</div>
